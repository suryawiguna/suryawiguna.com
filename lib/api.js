...
// moves on every republish) rather than `first_published_at`. Only posts come
// from Storyblok now — the static routes' dates live in content/site.ts.
export async function getSitemapEntries() {
  ...
  return posts.filter((post) => !isNoindex(post));
}
