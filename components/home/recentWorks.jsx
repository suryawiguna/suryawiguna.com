      ...
      <div className="grid grid-cols sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Link href="/portfolio" passHref>
          <a
            href=""
            rel="noreferrer"
            className="relative h-32 self-center rounded-2xl bg-zinc-100 dark:bg-zinc-700 dark:text-zinc-300 hover:scale-[0.98] transition-transform flex justify-center items-center text-zinc-500"
          >
            See more
